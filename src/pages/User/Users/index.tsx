...
import { getUsersFilter, updateUser, deleteUser } from '../../../store/User/Users'
import { selectUserList, selectUserListRowCount } from '../../../store/User/Users/selectors'
...
const columns: Column[] = [
  ...
  { id: 'emailVerified', label: 'Email Verified', minWidth: 80 },
  { id: 'phoneVerified', label: 'Phone Verified', minWidth: 80 },
...
export function Users() {
  ...
  const rowsCount = useAppSelector(selectUserListRowCount)
  ...
  const enableBtnClicked = (id: number) => {
    dispatch(updateUser({ id: id, status: STATUS.VALID }))
  }

  const disableBtnClicked = (id: number) => {
    dispatch(updateUser({ id: id, status: STATUS.INVALID }))
  }

  //-----------------------------------------------------------------
  return (
    <React.Fragment>
      <UserForm open={open} handleClose={handleClose} currentId={currentId} setCurrentId={setCurrentId} />
